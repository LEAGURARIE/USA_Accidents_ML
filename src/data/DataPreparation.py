# ==========================================================
# Data Preparation - Feature Engineering & Cleaning
# ==========================================================
from src.utils.helpers import *

# ---------------- I/O ----------------
in_path = os.path.join(INTERIM_DIR, "NYC_Accidents_with_FARS_raw.csv")
out_path = os.path.join(INTERIM_DIR, "df_prepared.csv")

df = load_csv_safe(in_path)
print_info(f"Loaded: {in_path}")
print(df.info())
...
if col_dist in df.columns:
    ...
    if not np.isfinite(dist).any():
        ...
        try:
            ...
            print_info("Distance bins fell back to dataset quantiles (median/Q3).")
...
print_ok(f"Saved CSV to: {out_path}")
